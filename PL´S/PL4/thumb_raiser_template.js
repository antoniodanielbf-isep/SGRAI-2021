 ...
 *  pointLight1: { color: Color, intensity: Number, range: Number, position: Vector3 },
 *  pointLight2: { color: Color, intensity: Number, range: Number, position: Vector3 },
 *  spotLight: { color: Color, intensity: Number, range: Number, angle: Number, penumbra: Number, position: Vector3, direction: Number }
 * }
 *
 * fogParameters = {
 *  enabled: Boolean,
            ...
            if (!this.animations.actionInProgress) {
                ...
                if (this.maze.foundExit(this.player.position)) {
                    ...
                    if (this.player.keyStates.run) {
                        ...
                        coveredDistance = this.player.runningFactor * coveredDistance;

                        /* To-do #15 - Adjust the player's direction increment
                            - now assume that the player is running:
                            - multiply the direction increment by this.player.runningFactor*/
                        directionIncrement = this.player.runningFactor * directionIncrement;
                    }
                    ...
                    if (this.player.keyStates.left) {
                        ...
                        let currentDirection = this.player.direction + directionIncrement;
                    }
